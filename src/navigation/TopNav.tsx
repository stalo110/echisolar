...
export default function TopNav() {
  ...
  // const drawer = (
  //   <Box sx={{ width: '100%', p: 2, background: 'black', color: 'white' }}>
  ...
  //       </Box>
  //       <IconButton onClick={handleDrawerToggle} aria-label="close drawer" sx={{color: "#ffffff"}}>
  //         <CloseIcon />
  //       </IconButton>
  //     </Box>
  ...
  //           </ListItemButton>
  //           <ListItemButton component="a" href="/cart" onClick={handleDrawerToggle}>
  //             <ListItemIcon>
...
const drawer = (
  ...
  >
        ...
        <>
          <ListItemButton
            ...
            sx={{
              ...
              mt: 2,
              '&:hover': {
                background: 'linear-gradient(90deg, var(--brand-amber), #ffbe6b)',
                color: '#000',
              },
            }}
          >
    ...
    {/* Bottom Section */}
    <Box sx={{ textAlign: 'center', mt: 'auto', opacity: 0.6, fontSize: '0.8rem' }}>
...
>
  <Toolbar disableGutters sx={{ justifyContent: "space-between" }}>
    ...
    >
      <Box component="img" src="/images/logo.png" alt="Echi Solar" sx={{ height: 30 }} />
    </Box>
    ...
    <Box sx={{ display: { xs: "none", md: "flex" }, gap: 3, alignItems: "center" }}>
      ...
      {!user ? (
        ...
        <>
          <Button
            href="/profile"
            startIcon={<AccountCircle sx={{ color: "var(--brand-green)" }} />}
    ...
    <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
      ...
      <Button
        ...
        sx={{
          ...
          borderRadius: 2,
          px: 3,
          boxShadow: "0 0 10px rgba(46,125,77,0.4)",
          "&:hover": {
            background: "linear-gradient(90deg, var(--brand-amber), #ffbe6b)",
            color: "#000",
          },
